...
const CloudflareWorks = (props: SVGProps<SVGSVGElement>) => (
  <svg
    height="231"
    ...
    {...props}
  >
    <title>Cloudflare Works</title>
    <defs>
      <linearGradient
        id="cloudflare_workers-a"
        x1="50%"
        x2="25.7%"
        y1="100%"
        y2="8.7%"
    ...
    <path
      ...
      fill="url(#cloudflare_workers-h)"
      opacity=".6"
    />
  </svg>
);
export default CloudflareWorks;
